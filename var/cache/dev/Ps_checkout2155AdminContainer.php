...
class Ps_checkout2155AdminContainer extends Container
{
    ...
    {
        return $this->services['ps_checkout.cache.directory'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('1.7.8.0', 'C:\\laragon\\www\\prestashop', true);
    }
